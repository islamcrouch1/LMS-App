...
class PasswordResetController extends Controller
{
    public function index($lang ,  $country)
    {
        ...
        return view('password-reset-request' , compact('countries' , 'scountry' ,  'links' ));
    }
    ...
    public function show($lang ,  $country , Request $request)
    {
        ...
        $user = User::find($request->user);
            ...
            return view('password-reset-confirm' , compact('countries' , 'scountry' ,  'links' , 'user' ));
    ...
    public function change($lang , $country , Request $request)
    {
        ...
        return view('password-reset-change'  , compact('countries' , 'scountry' ,  'links' , 'user' ));
