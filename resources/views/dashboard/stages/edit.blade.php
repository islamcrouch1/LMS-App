    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('stages.update' , ['lang'=>app()->getLocale() , 'stage'=>$stage->id , 'learning_system'=>$learning_system->id , 'country'=>$country->id])}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
