                ...
                <div class="card-body">
                    <form method="POST" action="{{route('posts.update' , ['lang'=>app()->getLocale() , 'post'=>$post->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="description_ar" type="text" class="form-control @error('description_ar') is-invalid @enderror" name="description_ar" value="{{ $post->description_ar }}"  autocomplete="description">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="description_en" type="text" class="form-control @error('description_en') is-invalid @enderror" name="description_en" value="{{ $post->description_ar }}"  autocomplete="description">
