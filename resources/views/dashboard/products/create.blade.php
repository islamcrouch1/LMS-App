    ...
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url(app()->getLocale() . '/dashboard/products' )}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input radio1 @error('type') is-invalid @enderror" type="radio" name="type" id="inlineRadio1" value="downloaded_product">
                                    <label class="form-check-label" for="inlineRadio1">{{ __('downloaded product') }}</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input radio2 @error('type') is-invalid @enderror" type="radio" name="type" id="inlineRadio2" value="physical_product">
